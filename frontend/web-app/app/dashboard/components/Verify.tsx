...
const app_id = "app_550b2d74aa400425dd38ee091d21ea90"; //process.env.NEXT_PUBLIC_WLD_APP_ID as `app_${string}`;
const action = "test1"; //process.env.NEXT_PUBLIC_WLD_ACTION as string;
